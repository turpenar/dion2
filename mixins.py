...
objects_path = pathlib.Path.cwd() / 'Resources' / 'objects.json'
...
# importing all items
items_path = pathlib.Path.cwd() / 'Resources' / 'items.json'
...
# importing all npcs
npcs_path = pathlib.Path.cwd() / 'Resources' / 'npcs.json'
with npcs_path.open(mode='r') as file:
    npcs = json.load(file)

# importing all enemies
enemies_path = pathlib.Path.cwd() / 'Resources' / 'enemies.json'
